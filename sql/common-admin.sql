...
CREATE TABLE `common_brrow_lend` (
  ...
  `borrow_lend_time` varchar(20) NOT NULL COMMENT '借入或借出时间',
  `money` varchar(255) NOT NULL COMMENT '金额',
  `note` varchar(255) NOT NULL COMMENT '备注',
  `borrow_user` varchar(255) NOT NULL COMMENT '借款人',
  `lend_user` varchar(255) NOT NULL COMMENT '借出人',
  `status` int(1) NOT NULL COMMENT '状态',
  `create_time` varchar(20) NOT NULL COMMENT '记录时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `common_deal_type` (
  ...
  `create_time` varchar(20) NOT NULL COMMENT '类型创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `common_income` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `income_time` varchar(20) NOT NULL COMMENT '进账时间',
  `income_money` varchar(255) NOT NULL COMMENT '金额',
  `income_type` varchar(255) NOT NULL COMMENT '类型',
  `income_user` varchar(255) NOT NULL COMMENT '用户',
  `income_note` varchar(255) NOT NULL COMMENT '备注',
  `create_time` varchar(20) NOT NULL COMMENT '记账时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `common_menu` VALUES ('1106900863944753152', 'history/list', 'bills', '894752734459199488', '历史列表', 'history/list', '1', '2', '1', '1', 'fa fa-book', '2019-03-16 20:51:46', '2019-03-16 21:53:46');
...
INSERT INTO `common_menu` VALUES ('1106906272881442816', 'outcome/list', 'bills', '894752734459199488', '支出列表', 'outcome/list', '1', '2', '3', '1', 'fa fa-location-arrow', '2019-03-16 21:13:15', '2019-03-16 22:05:13');
INSERT INTO `common_menu` VALUES ('1106906446622097408', 'income/list', 'bills', '894752734459199488', '收入列表', 'income/list', '1', '2', '2', '1', 'fa fa-circle-o', '2019-03-16 21:13:57', '2019-03-16 22:02:51');
...
INSERT INTO `common_menu` VALUES ('1106919967531466752', 'type', 'root', '000000000000000000', '交易项目', 'type', '1', '1', '3', '1', 'fa fa-list', '2019-03-16 22:07:40', '2019-03-16 22:08:29');
INSERT INTO `common_menu` VALUES ('1106920664020811776', 'intype/list', 'type', '1106919967531466752', '收入项目', 'intype/list', '1', '2', '1', '1', 'fa fa-circle-o', '2019-03-16 22:10:27', '2019-03-16 22:10:55');
INSERT INTO `common_menu` VALUES ('1106921151260524544', 'outtype/list', 'type', '1106919967531466752', '支出项目', 'outtype/list', '1', '2', '2', '1', 'fa fa-location-arrow', '2019-03-16 22:12:23', null);
...
INSERT INTO `common_menu` VALUES ('1106924873885679616', 'remind/list', 'plan', '1106921511500906496', '财务提醒', 'remind/list', '1', '2', '1', '1', 'fa fa-clock-o', '2019-03-16 22:27:10', '2019-03-16 22:30:53');
INSERT INTO `common_menu` VALUES ('1106925336056037376', 'borrow/list', 'plan', '1106921511500906496', '借入借出', 'borrow/list', '1', '2', '2', '1', 'fa fa-exchange', '2019-03-16 22:29:00', '2019-03-16 22:31:36');
INSERT INTO `common_menu` VALUES ('1106925513508651008', 'toloan/list', 'plan', '1106921511500906496', '借贷管理', 'toloan/list', '1', '2', '3', '1', 'fa fa-book', '2019-03-16 22:29:43', '2019-03-16 22:33:04');
...
CREATE TABLE `common_pay` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pay_time` varchar(20) NOT NULL COMMENT '支出时间',
  `pay_money` varchar(255) NOT NULL COMMENT '金额',
  `pay_type` varchar(255) NOT NULL COMMENT '类型',
  `pay_user` varchar(255) NOT NULL COMMENT '用户',
  `pay_note` varchar(255) NOT NULL COMMENT '备注',
  `create_time` varchar(20) NOT NULL COMMENT '记账时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `common_privilege` VALUES ('8', '1106903030818668544', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106908605833019392', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106908754596593664', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106908859693268992', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106912782072152064', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106922422579232768', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106922526077878272', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106922630637682688', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106919967531466752', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106920664020811776', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '1106921151260524544', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '893287144657780736', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '893288715881807872', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '893304960282787840', '2019-03-16 22:29:57');
INSERT INTO `common_privilege` VALUES ('8', '894396523532517376', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894473486712438784', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894473651837992960', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894475142061621248', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894475827880656896', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894475985452269568', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894476118730473472', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894476276402749440', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894476950951690240', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894477107919323136', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894477244926263296', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894477420512411648', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894477851082883072', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894477995903811584', '2019-03-16 22:29:58');
INSERT INTO `common_privilege` VALUES ('8', '894752734459199488', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106900863944753152', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106906272881442816', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106906446622097408', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106903030818668544', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106908605833019392', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106908754596593664', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106908859693268992', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106912782072152064', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106922422579232768', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106922526077878272', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106922630637682688', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106919967531466752', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106920664020811776', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106921151260524544', '2019-03-16 22:29:59');
INSERT INTO `common_privilege` VALUES ('8', '1106921511500906496', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '1106924873885679616', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '1106925336056037376', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '1106925513508651008', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '893287144657780736', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '893288715881807872', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '893304960282787840', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '894396523532517376', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '894473486712438784', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '894473651837992960', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '894475142061621248', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '894475827880656896', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '894475985452269568', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '894476118730473472', '2019-03-16 22:30:00');
INSERT INTO `common_privilege` VALUES ('8', '894476276402749440', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '894476950951690240', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '894477107919323136', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '894477244926263296', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '894477420512411648', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '894477851082883072', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '894477995903811584', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '894752734459199488', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '1106900863944753152', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '1106906272881442816', '2019-03-16 22:30:01');
INSERT INTO `common_privilege` VALUES ('8', '1106906446622097408', '2019-03-16 22:30:01');
